package com.cold.agecalculator
...
class MainActivity : AppCompatActivity() {
    ...
    private fun clickDatePicker() {
        ...
        val tvSelectedage: TextView = findViewById(R.id.tvSelectedage)
        ...
        val dpd = DatePickerDialog(
            this, { _, selectedYear, selectedMonth, selectedDayOfMonth ->
                ...
                getAge(selectedYear, selectedMonth, selectedDayOfMonth)
                /**
    ...
    fun getAge(year: Int, month: Int, day: Int): String {
        ...
        // val countDate = "01-01-2023 00:00:00"
        var month1 = month + 1
        val countDate1 = "" + day + "-" + month1 + "-" + "2022" + " 00:00:00"
        val now = Date()


        var age = today.get(Calendar.YEAR) - dob.get(Calendar.YEAR)
        var ageMonth = today.get(Calendar.MONTH) - dob.get(Calendar.MONTH)
        var agedays = today.get(Calendar.DATE) - dob.get(Calendar.DATE)
        // var agedays = today.get(Calendar.DATE) - dob.get(Calendar.DATE)
       // var agetime = today.get(Calendar.HOUR) - dob.get(Calendar.HOUR)
        ...
        try {
            ...
            val date: Date = sdf.parse(countDate1)
        ...
        tvSelectedage.text =
            ageInt.toString() + "Years" + Math.abs(ageMonth) + "Months" + agedays + "Days "
